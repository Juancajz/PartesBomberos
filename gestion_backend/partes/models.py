...
from usuarios.validators import validar_rut_chileno, validar_telefono_chileno
...
class Parte(models.Model):
    ...
    # --- ¡NUEVO CAMPO PARA EL CENTRALISTA! ---
    responsable_edicion = models.ForeignKey(Bombero, on_delete=models.SET_NULL, null=True, blank=True, related_name='partes_por_editar')
    
    # Datos Personas
    afectado_rut = models.CharField(max_length=20, blank=True, null=True,validators=[validar_rut_chileno])
    afectado_nombre = models.CharField(max_length=255, blank=True, null=True)
    afectado_telefono = models.CharField(max_length=20, blank=True, null=True,validators=[validar_telefono_chileno])
    denunciante_rut = models.CharField(max_length=20, blank=True, null=True,validators=[validar_rut_chileno])
