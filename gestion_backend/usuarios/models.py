...
class Bombero(AbstractUser):
    ...
    rut = models.CharField(max_length=12, unique=True, null=True, blank=True,validators=[validar_rut_chileno])
    ...
    # --- HOJA DE VIDA ---
    # 1. Contacto
    telefono = models.CharField(max_length=15, null=True, blank=True, verbose_name="Teléfono Móvil",validators=[validar_telefono_chileno])
    ...
    contacto_emergencia_telefono = models.CharField(max_length=15, null=True, blank=True,validators=[validar_telefono_chileno])
